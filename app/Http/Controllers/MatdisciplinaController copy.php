...
class MatdisciplinaController extends Controller
{
    ...
    {
     return view('matdisciplinas.index', ['matdisciplinas' => $model->paginate(10)]);     
    }
    ...
    public function store(Request $request)
    {
       ...
       if (!empty($disciplinas)) {
        ...
        //return redirect()->route('Matdisciplina.index')->withStatus(('Matricula na Disciplina ocorreu um erro.'));
    }
