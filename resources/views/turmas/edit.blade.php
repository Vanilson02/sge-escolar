...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('Turma.update', $turma) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')

            <div class="box ">
              <div class="box-header box-header-primary">
                <h4 class="box-title">{{ __('Editar Turma') }}</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="nometurma" id="input-name" type="text" placeholder="{{ __('Turma') }}" value="{{ old('NOMETURMA', $turma->NOMETURMA) }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
