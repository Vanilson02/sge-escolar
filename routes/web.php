...
Route::group(['middleware' => 'auth'], function () {
	...
	// para nota
	Route::get('Nota/turma/{id}','NotaController@getTurma');
	Route::get('Nota/disciplina/{id}','NotaController@getDisciplina');
	Route::get('Nota/aluno/{id}','NotaController@getAluno');
